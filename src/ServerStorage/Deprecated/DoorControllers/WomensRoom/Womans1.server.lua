...
game.Workspace.Women1.ClickDetector.MouseClick:Connect(function(player)
	if open == false then
		open = true
		game.ReplicatedStorage.Doors.WomensRoom.Womans1:FireAllClients(DoorSwingInfo, properties)
		wait(3)
		game.ReplicatedStorage.Doors.WomensRoom.Womans1:FireAllClients(closeInfo, closeProerties)
		wait(1.75)
		open = false
