...
game.Workspace.MenRight.ClickDetector.MouseClick:Connect(function(player)
	if open == false then
		open = true
		game.ReplicatedStorage.Doors.MensRoom.MensRight:FireAllClients(DoorSwingInfo, properties)
		wait(3)
		game.ReplicatedStorage.Doors.MensRoom.MensRight:FireAllClients(closeInfo, closeProerties)
		wait(1.75)
		open = false
