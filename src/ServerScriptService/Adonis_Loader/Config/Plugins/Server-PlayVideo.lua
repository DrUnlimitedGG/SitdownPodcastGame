...
return function(Vargs)
	...
	server.Commands.PlayVideo = {
		Prefix = server.Settings.Prefix;	-- Prefix to use for command
		Commands = {"playvideo"};	-- Commands
		Args = {"id"};	-- Command arguments
		...
		Function = function(plr,args)    -- Function to run for command
			if args[1] == nil then
				...
				workspace.CaptainTelevision.Screen.SurfaceGui.Video.Video = "rbxassetid://"..args[1]
				local id = args[1]
