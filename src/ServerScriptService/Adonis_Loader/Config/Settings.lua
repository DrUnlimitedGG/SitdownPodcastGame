...
----------------------------------------------
	...
	settings.DataStore = "hi"					 -- DataStore the script will use for saving data; Changing this will lose any saved data
	settings.DataStoreKey = "hi"			 -- CHANGE THIS TO SOMETHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
	...
	**HOW TO ADD ADMINISTRATORS:**
	...
	settings.Ranks = {
		...
		["Creators"] = {
			...
			Users = {"Peteant21"; "Axembix", "Coasterteam:26666928", "LordOfDisco"}
	...
	settings.SystemTitle = "Server Message"		-- Title to display in :sm and :bc
