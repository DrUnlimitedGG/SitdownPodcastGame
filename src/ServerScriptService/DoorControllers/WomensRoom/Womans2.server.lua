...
game.Workspace.Women2.ClickDetector.MouseClick:Connect(function(player)
	if open == false then
		open = true
		game.ReplicatedStorage.Doors.WomensRoom.Womans2:FireAllClients(DoorSwingInfo, properties)
		wait(3)
		game.ReplicatedStorage.Doors.WomensRoom.Womans2:FireAllClients(closeInfo, closeProerties)
		wait(1.75)
		open = false
