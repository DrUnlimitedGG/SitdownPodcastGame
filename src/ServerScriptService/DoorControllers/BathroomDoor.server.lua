...
game.Workspace.BathroomDoor.ClickDetector.MouseClick:Connect(function(player)

	if open == false then
		open = true
		game.ReplicatedStorage.Doors.BathroomDoor:FireAllClients(DoorSwingInfo, properties)
		door.DoorOpen:Play()
		wait(3)
		game.ReplicatedStorage.Doors.BathroomDoor:FireAllClients(closeInfo, closeProerties)
		wait(1.1)
		door.DoorClose:Play()
		wait(0.65)
		open = false
