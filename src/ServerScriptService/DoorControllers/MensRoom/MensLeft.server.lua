...
game.Workspace.MenLeft.ClickDetector.MouseClick:Connect(function(player)
	if open == false then
		open = true
		game.ReplicatedStorage.Doors.MensRoom.MensLeft:FireAllClients(DoorSwingInfo, properties)
		wait(3)
		game.ReplicatedStorage.Doors.MensRoom.MensLeft:FireAllClients(closeInfo, closeProerties)
		wait(1.75)
		open = false
